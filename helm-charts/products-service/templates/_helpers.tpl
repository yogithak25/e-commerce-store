...
helm.sh/chart: {{ include "products-service.chart" . }}
...
*/}}
{{- define "products-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "products-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
